        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              ...
              <a href="http://193.53.127.64:3000/store/New_Sale" class="btn-link btn-link_sm default-underline text-uppercase fw-medium animate animate_fade animate_btt animate_delay-7">Buy Now</a>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              ...
              <a href="http://193.53.127.64:3000/store/Bondage" class="btn-link btn-link_sm default-underline text-uppercase fw-medium animate animate_fade animate_btt animate_delay-7">Buy Now</a>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
...
<br/>Browse our collection of best-selling sex toys for women and read customer reviews to help you pick the best women's vibrator.</p>
              <a href="http://193.53.127.64:3000/store/Vibrators" class="btn-link btn-link_sm default-underline text-uppercase fw-medium animate animate_fade animate_btt animate_delay-7">Buy Now</a>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
...
<div class="row">
            ...
            {setcategoriaRef?.current?.map(item=>
                ...
                <div class="col-md-4">
                <div class="category-banner__item border-radius-10 mb-5">
                  <a href={`http://193.53.127.64:3000/store/${item.name}`}>
                  ...
                  <div class="category-banner__item-content">
                    ...
                    <a href={`http://193.53.127.64:3000/store/${item.name}`} class="btn-link default-underline text-uppercase fw-medium">Shop Now</a>
                  </div>
                </div>
                <div class="pb-2"></div>
              </div>
      ...
      <section class="hot-deals container margin-bottom">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 col-xl-20per d-flex align-items-center flex-column justify-content-center py-4 align-items-md-start">
            ...
            <a href="http://193.53.127.64:3000/store/New_Sale" class="btn-link default-underline text-uppercase fw-medium mt-3">View All</a>
          </div>
...
<div class="pc__info position-relative">
  ...
  {/* <div class="anim_appear-bottom position-absolute bottom-0 start-25 d-none d-sm-flex align-items-center bg-body">
    <a href={`http://193.53.127.64:3000/${item.id}`} class="btn-link btn-link_lg  text-uppercase fw-medium  " title="Go To Cart">Go To Cart</a>
      ...
      <div class="image-banner__content container py-3">
        ...
        <a href='http://193.53.127.64:3000/store/Male_Toys' class="btn btn-outline-primary border-0 fs-base text-uppercase fw-medium btn-55 d-inline-flex align-items-center">
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                <div class="pc__img-wrapper">
                  ...
                  <a  href={`http://193.53.127.64:3000/item/${item.id}`} class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium" title="Add To Cart">Go To Cart</a>
                </div>
...

{
  setonecategoria1Ref?.current?.map(item=>
    ...
    <div class="instagram__tile">
          <a href={`http://193.53.127.64:3000/item/${item.id}`} target="_blank" class="position-relative overflow-hidden d-block effect overlay-plus">
