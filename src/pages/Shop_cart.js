...
<main>
    ...
    <section class="shop-checkout container">
      ...
      <div class="checkout-steps">
        ...
        <a  href='https://wet-love.com:3000/checkout'  class="checkout-steps__item">
...
{setbasketItemRef?.current?.map(item=>
  ...
  <td>
    <div class="shopping-cart__product-item">
      <a href={`https://wet-love.com:3000/item/${item.ItemId}`} >
          ...
          <div class="sticky-content">
            ...
            <div class="mobile_fixed-btn_wrapper">
              <div class="button-wrapper container">
                <a href='https://wet-love.com:3000/checkout'  class="btn btn-primary btn-checkout">PROCEED TO CHECKOUT</a>
              </div>
            </div>
          </div>
        </div>
